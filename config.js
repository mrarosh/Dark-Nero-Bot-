...
global.sudo = process.env.SUDO || '94728699838'
global.devs = '94774071805';
global.website = 'https://kaveeshasithum.netlify.app/' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.ibb.co/T8wGgmD/Layer-1.png'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'MR.AROSH-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'MR.AROSH' : process.env.OWNER_NAME,
  ...
  caption :process.env.CAPTION || "*BY MR.AROSH SAMUDITHA*",
